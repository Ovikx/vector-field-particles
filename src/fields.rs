...
pub fn x_convergent(point: (i32, i32), _window_size: (u32, u32)) -> (f32, f32) {
    let magnitude = magnitude((point.0 as f32, point.1 as f32));
    (
...
pub fn y_convergent(point: (i32, i32), _window_size: (u32, u32)) -> (f32, f32) {
    let magnitude = magnitude((point.0 as f32, point.1 as f32));
    (
...
pub fn diag_convergent(point: (i32, i32), _window_size: (u32, u32)) -> (f32, f32) {
    let magnitude = magnitude((point.0 as f32, point.1 as f32));
    (
        (-point.0 + point.1) as f32 / magnitude,
        ((-point.1 + point.0) as f32 / 10.0) as f32 / magnitude,
    )
}
